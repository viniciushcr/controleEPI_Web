...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/img/fundo_branco_textura.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="index.php?pagina=dashBoard">
					<span class="login100-form-logo">
						<img class="login100-form-logo" src="assets/img/logo/logoSimboloEscritoAlfaTeste.png" alt="Logo">
					</span>
